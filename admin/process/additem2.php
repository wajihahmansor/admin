...
<div data-parsley-validate class="form-horizontal form-label-left" style="padding-left:5%;margin-top:3%;width:100%;">
      ...
      <div class="form-group">
        ...
        <div class="col-md-10 col-sm-10 col-xs-12">
          ...
          <label class="btn btn-default btn-circle btn-lg" title="YES"><input type="radio" name="shipping_status" value="YES"><i class="glyphicon glyphicon-ok"></i></label>
          <label class="btn btn-default btn-circle btn-lg" title="NO"><input type="radio" name="shipping_status" value="NO"><i class="glyphicon glyphicon-remove"></i></label><br><br>
        </div>
        </div>
      </div>
      <div class="form-group">
